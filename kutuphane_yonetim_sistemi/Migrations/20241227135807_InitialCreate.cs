        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KullaniciId1 = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AlisTarihi = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IadeTarihi = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OduncIslemleri", x => x.OduncId);
                    table.ForeignKey(
                        name: "FK_OduncIslemleri_AspNetUsers_KullaniciId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OduncIslemleri_KullaniciId1",
                table: "OduncIslemleri",
                column: "KullaniciId1");
        }
